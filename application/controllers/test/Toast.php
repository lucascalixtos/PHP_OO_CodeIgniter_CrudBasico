...
abstract class Toast extends MY_Controller
{
	...
	function _assert_true($assertion, $message = null) {
		if($assertion) {
			return TRUE;
		} else {
			if ($message != null) 
	...
	function _assert_false($assertion, $message = null) {
		if($assertion) {
			if ($message != null)
				$this->message = $message;
			$this->asserts = FALSE;
	...
	function _assert_true_strict($assertion, $message = null) {
		if($assertion === TRUE) {
			return TRUE;
		} else {
			if ($message != null)
	...
	function _assert_false_strict($assertion, $message = null) {
		if($assertion === FALSE) {
			return TRUE;
		} else {
			if ($message != null)
	...
	function _assert_equals($base, $check, $message = null) {
		if($base == $check) {
			return TRUE;
		} else {
			if ($message != null)
	...
	function _assert_not_equals($base, $check, $message = null) {
		if($base != $check) {
			return TRUE;
		} else {
			if ($message != null)
	...
	function _assert_equals_strict($base, $check, $message = null) {
		if($base === $check) {
			return TRUE;
		} else {
			if ($message != null)
	...
	function _assert_not_equals_strict($base, $check, $message = null) {
		if($base !== $check) {
			return TRUE;
		} else {
			if ($message != null)
	...
	function _assert_empty($assertion, $message = null) {
		if(empty($assertion)) {
			return TRUE;
		} else {
			if ($message != null)
	...
	function _assert_not_empty($assertion, $message = null) {
		if(!empty($assertion)) {
			return TRUE;
		} else {
			if ($message != null)
